...
There you will need to set up your developer's access: click on _"Apply for a developer account"_
...
On the next screen select the option that better suit your needs, for our tutorial, we will be using option 2 _"I am requesting access for my own personal use"_
...
You will need to specify the case for your access (_"Academic research"_ for me), write a 300 word description of your intended use and your relation to government entity
...
and you can set up your Twitter app now by clicking on _"Create an app"_
...
Click on _"Create a new App"_

Go to the _"Keys and Access Tokens"_ tab and click on _"Create my access token"_
