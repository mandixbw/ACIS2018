...
img <- readPNG(file.path("tutorial images/sydney1.png"))
grid.raster(img)
```
...
img <- readPNG(file.path("tutorial images/sydneydark.png"))
grid.raster(img)
```
...
img <- readPNG(file.path("tutorial images/melbournedays2.png"))
grid.raster(img)
```

```{r echo=FALSE,fig.cap="Frequencies of @CityOfMelbourne tweet, hours"}
img <- readPNG(file.path("tutorial images/melbournehours.png"))
grid.raster(img)
```
